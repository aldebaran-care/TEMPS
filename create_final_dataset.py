...
def create_final_dataset(real_dataset_path="original_temporal_dataset.csv", synthetic_dataset_path="synthetic_temporal_dataset.csv", output_file_path="training_dataset.csv"):
    """
    ...
    final_df = pd.concat([synthetic_df, original_df], ignore_index=True)
...
if __name__ == "__main__":
    ...
    create_final_dataset(real_dataset_path=args.real_dataset_path, synthetic_dataset_path=args.synthetic_dataset_path, output_file_path=args.output_file_path)