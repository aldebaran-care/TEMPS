...
def set_output_files(temporal_model_name: str, temporal_model_path: Path, semantic_model_name: str, benchmark_file_path: Path, eval_id: int) -> Dict:
    ...
    temporal_similarities_path = output_paths["temporal_similarities_path"].format(
    ...
    semantic_similarities_path = output_paths["semantic_similarities_path"].format(
        benchmark_stem=benchmark_stem,
        external_model_name=semantic_model_name,
        eval_id=eval_id
    )

    temporal_cache_path = output_paths["temporal_cache_path"].format(
        benchmark_stem=benchmark_stem,
        model_name=temporal_model_name,
        model_stem=temporal_model_path.stem,
        eval_id=eval_id
    ...
    semantic_cache_path = output_paths["semantic_cache_path"].format(
        benchmark_stem=benchmark_stem,
        external_model_name=semantic_model_name,
        eval_id=eval_id
    )
