from temporal_embeddings.data_utils.utils.dates.is_in import season_to_months
from datetime import datetime

def compute_distance_dates_same_type(first_date: str, second_date: str, date_type: str) -> int:
    if date_type == "yyyy":
    ...
    raise ValueError(f"Unknown date type for distance computation: {date_type}")

def compute_distance_dates(first_date: str, first_date_type: str, second_date: str, second_date_type: str) -> int:
