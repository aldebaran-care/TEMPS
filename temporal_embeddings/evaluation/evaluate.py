...
def evaluate_model(model_name: str, external_model_name: str, model_path: Path, batch_size: int, max_seq_len: int, benchmark: str, eval_id: str, top_k: int, metric: str, alpha: float, num_negative_samples: int = 0) -> None:
    ...
    if model_name in ["temporal_bert", "all-minilm-l6-v2", "prajjwal1/bert-tiny", "intfloat/e5-base-v2"]:
    ...
    elif model_name in ["temporal_bert_full", "all-minilm-l6-v2-full", "prajjwal1/bert-tiny-full", "intfloat/e5-base-v2-full"]:
